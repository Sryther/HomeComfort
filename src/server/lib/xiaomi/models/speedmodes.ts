...
interface SpeedLevelHomeKitTopLevel extends SpeedLevel {
...
interface SpeedModes {
    gen1: SpeedLevel[],
    gen2: SpeedLevel[],
    "gen2-no_mop": SpeedLevel[],
    "xiaowa-e202-02": SpeedLevel[],
    gen3: SpeedLevel[],
    gen4: SpeedLevel[],
    "gen4+custom": SpeedLevel[],
    viomi: SpeedLevel[]
}

interface SpeedModesHomeKitTopLevel extends SpeedModes{
    gen1: SpeedLevelHomeKitTopLevel[],
    gen2: SpeedLevelHomeKitTopLevel[],
    "gen2-no_mop": SpeedLevelHomeKitTopLevel[],
    "xiaowa-e202-02": SpeedLevelHomeKitTopLevel[],
    gen3: SpeedLevelHomeKitTopLevel[],
    gen4: SpeedLevelHomeKitTopLevel[],
    "gen4+custom": SpeedLevelHomeKitTopLevel[],
    viomi: SpeedLevelHomeKitTopLevel[]
}
 ...
 */
function autoAssignHomekitTopLevel() : SpeedModesHomeKitTopLevel {
...
export default autoAssignHomekitTopLevel();